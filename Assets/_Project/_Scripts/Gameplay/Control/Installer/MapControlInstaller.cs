...
namespace Gameplay.Control
{
    ...
    {
        [SerializeField] private CellsRaycaster _cellsRaycaster;
        [SerializeField] private ControlInitializer controlInitializer;
        ...
        public override void InstallBindings()
        {
            ...
            Container.BindInterfacesAndSelfTo<KeyboardManager>().AsSingle();
