...
namespace Audio.Music
{
    public class MusicService : MonoBehaviour, IMusicService
    {
        ...
        private async UniTask CheckMusicProgress()
        {
            while (!_isStopped)
            {
        ...
        private async UniTask ChangeMusicAnimationAsync(MusicData musicData)
        {
            try
            {
        ...
        private async UniTask PlayFadeInEffect(MusicData musicData)
        {
        ...
        private async UniTask PlayFadeOutEffect(MusicData currentMusic)
        {
